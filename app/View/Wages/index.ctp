...
<div id="page-content-wrapper">
    <div class="container-fluid">
        <div class="wages index">
            ...
            <h3>Total given: <?php echo number_format($totalAmount,2) ?> ISK</h3>
            <h3>Total bonus earned: <?php echo number_format(($totalAmount-$totalBrut),2) ?> ISK</h3>
            <h3>Total withdrawals given: <?php echo $withdrawals_number ?></h3>

            <table class="table table-striped table-condensed">
                <thead>
                <tr>
                    <th><?php echo $this->Paginator->sort('amount'); ?></th>
                    <th><?php echo $this->Paginator->sort('brut_value', 'Bonus'); ?></th>
                ...
                <?php foreach ($wages as $wage): ?>
                    <tr>
                        ...
                        <td><?php echo h(number_format($wage['Wage']['amount']-$wage['Wage']['brut_value'], 2).' ISK'); ?>&nbsp;</td>
