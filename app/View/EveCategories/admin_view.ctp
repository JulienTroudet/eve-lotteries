					...
					<table class="table table-striped table-condensed">
						...
						<?php foreach ($eveCategory['EveItem'] as $eveItem): ?>
							<tr>
								...
								<td class="actions">
									<?php echo $this->Html->link(__('View'), array('controller' => 'eve_items', 'action' => 'view', 'admin' => true, $eveItem['id'])); ?>
									<?php echo $this->Html->link(__('Edit'), array('controller' => 'eve_items', 'action' => 'edit', 'admin' => true, $eveItem['id'])); ?>
									<?php echo $this->Form->postLink(__('Delete'), array('controller' => 'eve_items', 'action' => 'delete', 'admin' => true, $eveItem['id']), array(), __('Are you sure you want to delete # %s?', $eveItem['id'])); ?>
								</td>
							</tr>
						<?php endforeach; ?>
					</table>
