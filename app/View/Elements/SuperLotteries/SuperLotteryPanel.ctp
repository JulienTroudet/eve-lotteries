<?php if(isset($superLottery['SuperLottery'])):?>
    <div class="row super-lot">
                    ...
                    <?php if($superLottery['SuperLottery']['status']=='ongoing'): ?>
                        <div>
                            ...
                            <div class="row row-super-lot">
                                ...
                                <div class="col-md-3 col-sm-3 col-xs-3 col-btn-super-lot" data-toggle="tooltip" data-placement="left" title="50 tickets for 50 points">
                                    <button class="btn btn-primary buy-super-ticket" data-id-super="<?php echo $superLottery['SuperLottery']['id']; ?>" data-nb-ticket="50">
                                        50
                                    </button>
                                </div>
                                <div class="col-md-3 col-sm-3 col-xs-3 col-btn-super-lot" data-toggle="tooltip" data-placement="left" title="100 tickets for 100 points">
                                    <button class="btn btn-primary buy-super-ticket" data-id-super="<?php echo $superLottery['SuperLottery']['id']; ?>" data-nb-ticket="100">
                                        100
                                    </button>
                                </div>
                            </div>
        ...
        </div>	</div>	<?php if(isset($timestamp_super_lotteries)) :?>
        <input type="hidden" id="timestamp-super-lotteries" value="<?php echo $timestamp_super_lotteries; ?>"/>	<?php endif; ?><?php endif; ?>